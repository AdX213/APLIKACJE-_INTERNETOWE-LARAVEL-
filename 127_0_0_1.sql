...
--
-- Database: `klubwedkarski`
--
CREATE DATABASE IF NOT EXISTS `klubwedkarski` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `klubwedkarski`;
...
INSERT INTO `clubs` (`id`, `name`, `location`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Fishing Club A', 'Lakeview', 'Club A is focused on lake fishing.', NULL, NULL),
(2, 'Fishing Club B', 'Riverside', 'Club B specializes in river fishing.', NULL, NULL),
(3, 'Fishing Club C', 'Seaside', 'Club C enjoys ocean fishing.', NULL, NULL);
...
INSERT INTO `members` (`id`, `name`, `email`, `phone`, `club_id`, `created_at`, `updated_at`) VALUES
(1, 'John Doe', 'john.doe@example.com', '123456789', 1, NULL, NULL),
(2, 'Jane Smith', 'jane.smith@example.com', '987654321', 2, NULL, NULL),
(3, 'Jim Brown', 'jim.brown@example.com', '456789123', 1, NULL, NULL),
(4, 'Lucy White', 'lucy.white@example.com', '789123456', 3, NULL, NULL);
...
(4, '2024_05_28_182624_create_clubs_table', 1),
(5, '2024_05_28_182637_create_members_table', 1);
...
(1, 'Admin', 'admin@example.com', '2025-03-21 13:29:44', '$2y$12$EZ2YIaipDTJAlmz3.383QOVutNWQCzNyhIMxSg/i3XVBNGIeudX..', 'admin', 'ohcTh033i2', '2025-03-21 13:29:44', '2025-03-21 13:29:44');
...
('root', '2025-03-21 15:01:22', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
